...
FROM months m
LEFT JOIN t1 ON t1.month = m.month
LEFT JOIN t2 ON t2.month = m.month


/* t1
{"headers": ["month", "active_drivers"],
{values": [[12, 1], [1, 2], [2, 3], [3, 4], [5, 5], [10, 6]]} */
/*

*/
/* t2
{"headers": ["month", "accepted_rides"],
"values": [[3, 1], [6, 1], [7, 1], [8, 1], [11, 2], [12, 1]]}
*/
